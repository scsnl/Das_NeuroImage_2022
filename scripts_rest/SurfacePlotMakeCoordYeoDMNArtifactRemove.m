%Anup Das
%20 September, 2019
%This program finds the coordinates for the DMN in the Yeo atlas for surface plotting
...
load(strcat(Str_Subj, 'SubjIndGlobal_7_Yeo2011_HIPP_ArtifactRemove_1229.mat'));

NSubjects = size(MNIAllSubjectFilledBipolar,1);
isinterDMNFilledCell1 = cell(NSubjects,1);

roiFile1 = strcat('Yeo2011_7Networks_MNI152_FreeSurferConformed1mm_7.nii');

for i_Subject = 1:NSubjects
    
    isinterDMNFilledCell1{i_Subject,1} = FindRegionHO(MNIAllSubjectFilledBipolar{i_Subject,1}, strcat(Str_Masks,roiFile1), 7);
...
save(strcat('SurfacePlotCoordYeo_7_ArtifactRemove_1229.mat'),'SurfacePlotCoord');
