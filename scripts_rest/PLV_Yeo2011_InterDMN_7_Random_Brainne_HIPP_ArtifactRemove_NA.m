%Anup Das
%16 August, 2019
%Surrogate PLV calculation for inter-DMN in the Yeo2011 atlas after including
...
for i_interDMN = 1:6
    ...
    if (~isempty(SubjInd))
        ...
        PLVVals_interDMN_UltraSlow_Delta = [PLVVals_interDMN_UltraSlow_Delta; PLVCalc_PCCPrec_X_Random_UltraSlow_NA(RegXData, RegYData, UltraSlow_Delta)];
        PLVVals_interDMN_UltraSlow_Delta_Theta = [PLVVals_interDMN_UltraSlow_Delta_Theta; PLVCalc_PCCPrec_X_Random_UltraSlow_NA(RegXData, RegYData, UltraSlow_Delta_Theta)];
        PLVVals_interDMN_Delta_Theta = [PLVVals_interDMN_Delta_Theta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Delta_Theta)];
        PLVVals_interDMN_UltraSlow = [PLVVals_interDMN_UltraSlow; PLVCalc_PCCPrec_X_Random_UltraSlow_NA(RegXData, RegYData, UltraSlow)];
        PLVVals_interDMN_HighGamma = [PLVVals_interDMN_HighGamma; PLVCalc_PCCPrec_X_Random_HighGamma_NA(RegXData, RegYData, HighGamma)];
        PLVVals_interDMN_Delta = [PLVVals_interDMN_Delta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Delta)];
        PLVVals_interDMN_Theta = [PLVVals_interDMN_Theta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Theta)];
        PLVVals_interDMN_Alpha = [PLVVals_interDMN_Alpha; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Alpha)];
        PLVVals_interDMN_Beta = [PLVVals_interDMN_Beta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Beta)];
        PLVVals_interDMN_Gamma = [PLVVals_interDMN_Gamma; PLVCalc_PCCPrec_X_Random_Gamma_NA(RegXData, RegYData, Gamma)];
        ...
        save(strcat(StrSaveSubjIndGlobal,'SubjIndGlobal_interDMN_',num2str(i_interDMN),'_HIPP_Yeo2011_ArtifactRemove.mat'),'SubjInd');
        
        save(strcat(StrSavePLVVals,'NA_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Delta');
        save(strcat(StrSavePLVVals,'NA_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Theta');
        save(strcat(StrSavePLVVals,'NA_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Alpha_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Alpha');
        save(strcat(StrSavePLVVals,'NA_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Beta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Beta');
        save(strcat(StrSavePLVVals,'NA_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Gamma_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Gamma');
        save(strcat(StrSavePLVVals,'NA_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_UltraSlow_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_UltraSlow');
        save(strcat(StrSavePLVVals,'NA_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_HighGamma_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_HighGamma');
        save(strcat(StrSavePLVVals,'NA_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_UltraSlow_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_UltraSlow_Delta');
        save(strcat(StrSavePLVVals,'NA_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_UltraSlow_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_UltraSlow_Delta_Theta');
        save(strcat(StrSavePLVVals,'NA_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Delta_Theta');
        
        save(strcat(StrSaveSampFreq,'SampFreq_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_ArtifactRemove.mat'),'SampFreq_interDMN');
