...
%         end
    ...
    if (~isempty(SubjInd))
        ...
        save(strcat(StrSaveSubjIndGlobal,'SubjIndGlobal_',num2str(i_All),'_Yeo2011_HIPP_ArtifactRemove_1229.mat'),'SubjInd');
    ...
    save(strcat(StrSavePowerVals,'PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Delta_Corrected_Random_ArtifactRemove_1229.mat'),'Power_Delta');
    save(strcat(StrSavePowerVals,'PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Theta_Corrected_Random_ArtifactRemove_1229.mat'),'Power_Theta');
    save(strcat(StrSavePowerVals,'PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Alpha_Corrected_Random_ArtifactRemove_1229.mat'),'Power_Alpha');
    save(strcat(StrSavePowerVals,'PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Beta_Corrected_Random_ArtifactRemove_1229.mat'),'Power_Beta');
    save(strcat(StrSavePowerVals,'PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Gamma_Corrected_Random_ArtifactRemove_1229.mat'),'Power_Gamma');
    save(strcat(StrSavePowerVals,'PowerVals_',num2str(i_All),'_Yeo2011_HIPP_UltraSlow_Corrected_Random_ArtifactRemove_1229.mat'),'Power_UltraSlow');
    save(strcat(StrSavePowerVals,'PowerVals_',num2str(i_All),'_Yeo2011_HIPP_HighGamma_Corrected_Random_ArtifactRemove_1229.mat'),'Power_HighGamma');
    save(strcat(StrSavePowerVals,'PowerVals_',num2str(i_All),'_Yeo2011_HIPP_UltraSlow_Delta_Corrected_Random_ArtifactRemove_1229.mat'),'Power_UltraSlow_Delta');
    save(strcat(StrSavePowerVals,'PowerVals_',num2str(i_All),'_Yeo2011_HIPP_UltraSlow_Delta_Theta_Corrected_Random_ArtifactRemove_1229.mat'),'Power_UltraSlow_Delta_Theta');
    save(strcat(StrSavePowerVals,'PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Delta_Theta_Corrected_Random_ArtifactRemove_1229.mat'),'Power_Delta_Theta');
    
    save(strcat(StrSaveSampFreq,'SampFreq_',num2str(i_All),'_Yeo2011_HIPP_ArtifactRemove_1229.mat'),'SampFreq_All');
