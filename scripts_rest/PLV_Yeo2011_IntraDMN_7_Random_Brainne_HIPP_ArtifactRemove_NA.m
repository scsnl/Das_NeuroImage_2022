%Anup Das
%16 August, 2019
%Surrogate PLV calculation for intra-DMN in the Yeo2011 atlas after including
...
for i_intraDMN = 20:27
    ...
    if (~isempty(SubjInd))
        ...
        PLVVals_intraDMN_UltraSlow_Delta = [PLVVals_intraDMN_UltraSlow_Delta; PLVCalc_PCCPrec_X_Random_UltraSlow_NA(RegXData, RegYData, UltraSlow_Delta)];
        PLVVals_intraDMN_UltraSlow_Delta_Theta = [PLVVals_intraDMN_UltraSlow_Delta_Theta; PLVCalc_PCCPrec_X_Random_UltraSlow_NA(RegXData, RegYData, UltraSlow_Delta_Theta)];
        PLVVals_intraDMN_Delta_Theta = [PLVVals_intraDMN_Delta_Theta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Delta_Theta)];
        PLVVals_intraDMN_UltraSlow = [PLVVals_intraDMN_UltraSlow; PLVCalc_PCCPrec_X_Random_UltraSlow_NA(RegXData, RegYData, UltraSlow)];
        PLVVals_intraDMN_HighGamma = [PLVVals_intraDMN_HighGamma; PLVCalc_PCCPrec_X_Random_HighGamma_NA(RegXData, RegYData, HighGamma)];
        PLVVals_intraDMN_Delta = [PLVVals_intraDMN_Delta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Delta)];
        PLVVals_intraDMN_Theta = [PLVVals_intraDMN_Theta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Theta)];
        PLVVals_intraDMN_Alpha = [PLVVals_intraDMN_Alpha; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Alpha)];
        PLVVals_intraDMN_Beta = [PLVVals_intraDMN_Beta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Beta)];
        PLVVals_intraDMN_Gamma = [PLVVals_intraDMN_Gamma; PLVCalc_PCCPrec_X_Random_Gamma_NA(RegXData, RegYData, Gamma)];
...
save(strcat(StrSavePLVVals,'NA_PLVVals_intraDMN_Yeo2011_Random_Brainnetome_HIPP_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_intraDMN_Delta');
save(strcat(StrSavePLVVals,'NA_PLVVals_intraDMN_Yeo2011_Random_Brainnetome_HIPP_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intraDMN_Theta');
save(strcat(StrSavePLVVals,'NA_PLVVals_intraDMN_Yeo2011_Random_Brainnetome_HIPP_Alpha_Corrected_ArtifactRemove.mat'),'PLVVals_intraDMN_Alpha');
save(strcat(StrSavePLVVals,'NA_PLVVals_intraDMN_Yeo2011_Random_Brainnetome_HIPP_Beta_Corrected_ArtifactRemove.mat'),'PLVVals_intraDMN_Beta');
save(strcat(StrSavePLVVals,'NA_PLVVals_intraDMN_Yeo2011_Random_Brainnetome_HIPP_Gamma_Corrected_ArtifactRemove.mat'),'PLVVals_intraDMN_Gamma');
save(strcat(StrSavePLVVals,'NA_PLVVals_intraDMN_Yeo2011_Random_Brainnetome_HIPP_UltraSlow_Corrected_ArtifactRemove.mat'),'PLVVals_intraDMN_UltraSlow');
save(strcat(StrSavePLVVals,'NA_PLVVals_intraDMN_Yeo2011_Random_Brainnetome_HIPP_HighGamma_Corrected_ArtifactRemove.mat'),'PLVVals_intraDMN_HighGamma');
save(strcat(StrSavePLVVals,'NA_PLVVals_intraDMN_Yeo2011_Random_Brainnetome_HIPP_UltraSlow_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_intraDMN_UltraSlow_Delta');
save(strcat(StrSavePLVVals,'NA_PLVVals_intraDMN_Yeo2011_Random_Brainnetome_HIPP_UltraSlow_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intraDMN_UltraSlow_Delta_Theta');
save(strcat(StrSavePLVVals,'NA_PLVVals_intraDMN_Yeo2011_Random_Brainnetome_HIPP_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intraDMN_Delta_Theta');
