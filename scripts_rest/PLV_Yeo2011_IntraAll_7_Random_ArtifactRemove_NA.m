%Anup Das
%6 August, 2019
%Surrogate PLV calculation for intra-networks in the Yeo2011 atlas
...
for i_Cluster_IDs = 7:7
    ...
    for i_intra = Cluster_IDs(i_Cluster_IDs,1):Cluster_IDs(i_Cluster_IDs,2)-1%20:26
        ...
        for j_intra = i_intra+1:Cluster_IDs(i_Cluster_IDs,2)
            ...
            if (~isempty(SubjInd))
                ...
                PLVVals_intra_UltraSlow_Delta = [PLVVals_intra_UltraSlow_Delta; PLVCalc_PCCPrec_X_Random_UltraSlow_NA(RegXData, RegYData, UltraSlow_Delta)];
                PLVVals_intra_UltraSlow_Delta_Theta = [PLVVals_intra_UltraSlow_Delta_Theta; PLVCalc_PCCPrec_X_Random_UltraSlow_NA(RegXData, RegYData, UltraSlow_Delta_Theta)];
                PLVVals_intra_Delta_Theta = [PLVVals_intra_Delta_Theta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Delta_Theta)];
                PLVVals_intra_UltraSlow = [PLVVals_intra_UltraSlow; PLVCalc_PCCPrec_X_Random_UltraSlow_NA(RegXData, RegYData, UltraSlow)];
                PLVVals_intra_HighGamma = [PLVVals_intra_HighGamma; PLVCalc_PCCPrec_X_Random_HighGamma_NA(RegXData, RegYData, HighGamma)];
                PLVVals_intra_Delta = [PLVVals_intra_Delta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Delta)];
                PLVVals_intra_Theta = [PLVVals_intra_Theta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Theta)];
                PLVVals_intra_Alpha = [PLVVals_intra_Alpha; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Alpha)];
                PLVVals_intra_Beta = [PLVVals_intra_Beta; PLVCalc_PCCPrec_X_Random_NA(RegXData, RegYData, Beta)];
                PLVVals_intra_Gamma = [PLVVals_intra_Gamma; PLVCalc_PCCPrec_X_Random_Gamma_NA(RegXData, RegYData, Gamma)];
    ...
    save(strcat(StrSavePLVVals,'NA_PLVVals_intraNet_',num2str(i_Cluster_IDs),'_Yeo2011_Random_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Delta');
    save(strcat(StrSavePLVVals,'NA_PLVVals_intraNet_',num2str(i_Cluster_IDs),'_Yeo2011_Random_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Theta');
    save(strcat(StrSavePLVVals,'NA_PLVVals_intraNet_',num2str(i_Cluster_IDs),'_Yeo2011_Random_Alpha_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Alpha');
    save(strcat(StrSavePLVVals,'NA_PLVVals_intraNet_',num2str(i_Cluster_IDs),'_Yeo2011_Random_Beta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Beta');
    save(strcat(StrSavePLVVals,'NA_PLVVals_intraNet_',num2str(i_Cluster_IDs),'_Yeo2011_Random_Gamma_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Gamma');  
    save(strcat(StrSavePLVVals,'NA_PLVVals_intraNet_',num2str(i_Cluster_IDs),'_Yeo2011_Random_UltraSlow_Corrected_ArtifactRemove.mat'),'PLVVals_intra_UltraSlow');
    save(strcat(StrSavePLVVals,'NA_PLVVals_intraNet_',num2str(i_Cluster_IDs),'_Yeo2011_Random_HighGamma_Corrected_ArtifactRemove.mat'),'PLVVals_intra_HighGamma'); 
    save(strcat(StrSavePLVVals,'NA_PLVVals_intraNet_',num2str(i_Cluster_IDs),'_Yeo2011_Random_UltraSlow_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_UltraSlow_Delta');
    save(strcat(StrSavePLVVals,'NA_PLVVals_intraNet_',num2str(i_Cluster_IDs),'_Yeo2011_Random_UltraSlow_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_UltraSlow_Delta_Theta');
    save(strcat(StrSavePLVVals,'NA_PLVVals_intraNet_',num2str(i_Cluster_IDs),'_Yeo2011_Random_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Delta_Theta');
