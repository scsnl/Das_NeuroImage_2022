%Anup Das
%3 November, 2019
%Surrogate PTE calculation for inter-DMN in the Yeo2011 atlas 
...
for i_interDMN = 1:6
    ...
    if (~isempty(SubjInd))
        ...
        PTE_Rand_Global = PTECalc_Random_NA(RegXData, RegYData);
       
        save(strcat(StrSavePTEVals,'NA_PTEVals_DMNHIPP_',num2str(i_interDMN),'_Random_Yeo2011_ArtifactRemove.mat'),'PTE_Rand_Global');
