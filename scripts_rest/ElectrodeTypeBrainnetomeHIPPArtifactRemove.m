%Anup Das
%28 March, 2020
%This program finds the electrode types in the Brainnetome atlas
...
save(strcat(StrSave,'ElectrodeTypeGlobalBrainnetome_HIPP_ArtifactRemove_1229.mat'),'ElectrodeTypeGlobal');
