...
for i_interDMN = 1:6
    ...
    if (~isempty(SubjInd))
        ...
        save(strcat(StrSavePLVVals,'PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Delta');
        save(strcat(StrSavePLVVals,'PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Theta');
        save(strcat(StrSavePLVVals,'PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Alpha_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Alpha');
        save(strcat(StrSavePLVVals,'PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Beta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Beta');
        save(strcat(StrSavePLVVals,'PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Gamma_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Gamma');
        save(strcat(StrSavePLVVals,'PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_UltraSlow_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_UltraSlow');
        save(strcat(StrSavePLVVals,'PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_HighGamma_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_HighGamma');
        save(strcat(StrSavePLVVals,'PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_UltraSlow_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_UltraSlow_Delta');
        save(strcat(StrSavePLVVals,'PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_UltraSlow_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_UltraSlow_Delta_Theta');
        save(strcat(StrSavePLVVals,'PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Random_Brainnetome_HIPP_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_interDMN_Delta_Theta');
