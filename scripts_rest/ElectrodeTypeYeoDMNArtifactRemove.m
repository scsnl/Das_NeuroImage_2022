%Anup Das
%28 March, 2020
%This program finds the electrode types in the Yeo atlas for the DMN
...
for i_interDMN = 7:7
    ...
    load(strcat(Str_Subj, 'SubjIndGlobal_', num2str(i_interDMN),'_Yeo2011_HIPP_ArtifactRemove_1229.mat'));
    ...
    save(strcat(StrSave,'ElectrodeTypeGlobalYeo_',num2str(i_interDMN),'_ArtifactRemove_1229.mat'),'ElectrodeTypeGlobal');
