%Anup Das
%30 August, 2019
%Creating mixed effects models for the 7-networks in the Yeo2011 atlas in the
...
Subject_Files_Dir = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_DMN_Project/scripts/Release_20171012_scripts/scripts_task/Subject_Indices/Yeo_atlas/Individual/Recall/';
Subject_Files = dir(strcat(Subject_Files_Dir, 'SubjIndGlobal_*_Yeo2011_ArtifactRemove.mat'));
Subject_All = {};
for j=1:length(Subject_Files)-1
...
%save variables
StrSavePowerVals = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_DMN_Project/scripts/Release_20171012_scripts/scripts_task/Mixed_Effects_Results/Yeo_atlas/Inter_7/Recall/';
...
for i_All = 1:6
    ...
    if (~isempty(SubjInd))
        ...
        save(strcat(StrSavePowerVals,'Subj_Pairs_Individual_',num2str(i_All),'_Yeo2011_ArtifactRemove.mat'),'Subj_Pairs');
