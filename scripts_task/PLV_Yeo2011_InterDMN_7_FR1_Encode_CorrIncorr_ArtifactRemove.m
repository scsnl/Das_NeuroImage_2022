...
for i_interDMN = 5:6
    ...
    for i_Subject = 1:NSubjects
        ...
        temp1 = FindRegionHO(MNIAllSubjectFilledBipolar{i_Subject,1}, strcat(Str_Masks,roiFile1), 7);
        if sum(temp1)>0
    ...
    if (~isempty(SubjInd))
        ...
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_UltraSlow_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_UltraSlow_Delta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_UltraSlow_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_UltraSlow_Delta_Theta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Delta_Theta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_UltraSlow_Corrected_ArtifactRemove.mat'),'PLVVals_inter_UltraSlow');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Delta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Theta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Alpha_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Alpha');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Beta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Beta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Gamma_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Gamma');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_HighGamma_Corrected_ArtifactRemove.mat'),'PLVVals_inter_HighGamma');
