%Anup Das
%8 April, 2019
%Gamma amplitude calculation for inter-DMN-networks in the Yeo2011 
%atlas for the DMN for the recall periods of the FR1 task
...
%save variables
StrSaveGammaVals = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_DMN_Project/scripts/Release_20171012_scripts/scripts_task/Gamma_Results/Yeo_atlas/Recall/Inter_7/';

for i_interDMN = 1:6
    
    %Gamma amplitude values
    GammaAmplitudeVals_inter = [];
    ...
    if (~isempty(SubjInd))
        ...
        GammaAmplitudeVals_inter = [GammaAmplitudeVals_inter; GammaVals];
        
        save(strcat(StrSaveGammaVals,'CorrIncorr_GammaAmplitudeVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Corrected_ArtifactRemove.mat'),'GammaAmplitudeVals_inter');
