%Anup Das
%30 August, 2019
%PLV calculation for inter-DMN in the Yeo2011 atlas for 7-Networks in the
...
for i_interDMN = 1:6
    ...
    if (~isempty(SubjInd))
        ...
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_UltraSlow_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_UltraSlow_Delta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_UltraSlow_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_UltraSlow_Delta_Theta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Delta_Theta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_UltraSlow_Corrected_ArtifactRemove.mat'),'PLVVals_inter_UltraSlow');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Delta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Theta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Alpha_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Alpha');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Beta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Beta');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Gamma_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Gamma');
        save(strcat(StrSavePLVVals,'CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_HighGamma_Corrected_ArtifactRemove.mat'),'PLVVals_inter_HighGamma');
