...
%atlas for the 7 networks for the recall periods of the FR1 task
...
save(strcat(StrSaveGammaVals,'CorrIncorr_GammaAmplitudeVals_intraDMN_Yeo2011_Corrected_ArtifactRemove.mat'),'GammaAmplitudeVals_intra');
