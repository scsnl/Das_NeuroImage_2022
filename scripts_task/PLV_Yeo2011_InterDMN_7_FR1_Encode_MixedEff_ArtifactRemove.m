...
Subject_Files_Dir = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_DMN_Project/scripts/Release_20171012_scripts/scripts_task/Subject_Indices/Yeo_atlas/Inter_7/Encode/';
Subject_Files = dir(strcat(Subject_Files_Dir, 'SubjIndGlobal_interDMN_*_Yeo2011_*.mat'));
Subject_All = {};
for j=1:round(length(Subject_Files)/2)
    
    load(strcat(Subject_Files_Dir, Subject_Files(round(2*j)).name));
...
%save variables
StrSavePLVVals = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_DMN_Project/scripts/Release_20171012_scripts/scripts_task/Mixed_Effects_Results/Yeo_atlas/Inter_7/Encode/';
...
for i_interDMN = 1:6
    ...
    if (~isempty(SubjInd))
        ...
        save(strcat(StrSavePLVVals,'Subj_Pairs_interDMN_',num2str(i_interDMN),'_Yeo2011_ArtifactRemove.mat'),'Subj_Pairs');
