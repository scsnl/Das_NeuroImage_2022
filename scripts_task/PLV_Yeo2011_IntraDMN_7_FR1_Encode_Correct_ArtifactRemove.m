...
%for encode periods (correct) in the FR1 task
    ...
    for j_intraDMN = i_intraDMN+1:27
        ...
        if (~isempty(SubjInd))
            ...
            for i=1:size(SubjInd,1)
                ...
                Recalled_Correct = CountStartTemp(Recalled_Mat_Word==0);
...
save(strcat(StrSavePLVVals,'Incorrect_PLVsqueueVals_intraDMN_Yeo2011_UltraSlow_Corrected_ArtifactRemove.mat'),'PLVVals_intra_UltraSlow');
