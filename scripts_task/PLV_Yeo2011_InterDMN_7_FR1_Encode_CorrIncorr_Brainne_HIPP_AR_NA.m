%Anup Das
%30 August, 2019
%Surrogate PLV calculation for inter-DMN (including the hippocampus) in the Yeo2011 atlas for 7-Networks in the
...
%save variables
StrSavePLVVals = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_DMN_Project/scripts/Release_20171012_scripts/scripts_task/PLV_Results/Yeo_atlas/Inter_7/Encode/';
...
for i_interDMN = 1:6
    ...
    if (~isempty(SubjInd))
        ...
        PLVVals_inter_UltraSlow_Delta = [PLVVals_inter_UltraSlow_Delta; PLVCalc_PCCPrec_X_UltraSlow_NA(RegXData, RegYData, UltraSlow_Delta)];
        PLVVals_inter_UltraSlow_Delta_Theta = [PLVVals_inter_UltraSlow_Delta_Theta; PLVCalc_PCCPrec_X_UltraSlow_NA(RegXData, RegYData, UltraSlow_Delta_Theta)];
        PLVVals_inter_Delta_Theta = [PLVVals_inter_Delta_Theta; PLVCalc_PCCPrec_X_NA(RegXData, RegYData, Delta_Theta)];  
        PLVVals_inter_UltraSlow = [PLVVals_inter_UltraSlow; PLVCalc_PCCPrec_X_UltraSlow_NA(RegXData, RegYData, UltraSlow)];
        PLVVals_inter_HighGamma = [PLVVals_inter_HighGamma; PLVCalc_PCCPrec_X_HighGamma_NA(RegXData, RegYData, HighGamma)];
        PLVVals_inter_Delta = [PLVVals_inter_Delta; PLVCalc_PCCPrec_X_NA(RegXData, RegYData, Delta)];
        PLVVals_inter_Theta = [PLVVals_inter_Theta; PLVCalc_PCCPrec_X_NA(RegXData, RegYData, Theta)];
        PLVVals_inter_Alpha = [PLVVals_inter_Alpha; PLVCalc_PCCPrec_X_NA(RegXData, RegYData, Alpha)];
        PLVVals_inter_Beta = [PLVVals_inter_Beta; PLVCalc_PCCPrec_X_NA(RegXData, RegYData, Beta)];
        PLVVals_inter_Gamma = [PLVVals_inter_Gamma; PLVCalc_PCCPrec_X_Gamma_NA(RegXData, RegYData, Gamma)];
       
        save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_UltraSlow_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_UltraSlow_Delta');
        save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_UltraSlow_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_UltraSlow_Delta_Theta');
        save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Delta_Theta');
        save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_UltraSlow_Corrected_ArtifactRemove.mat'),'PLVVals_inter_UltraSlow');
        save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Delta');
        save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Theta');
        save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Alpha_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Alpha');
        save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Beta_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Beta');
        save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_Gamma_Corrected_ArtifactRemove.mat'),'PLVVals_inter_Gamma');
        save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_HighGamma_Corrected_ArtifactRemove.mat'),'PLVVals_inter_HighGamma');
