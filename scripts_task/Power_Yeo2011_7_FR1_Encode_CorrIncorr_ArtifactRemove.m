%Anup Das
%30 August, 2019
%Power calculation for the 7-networks in the Yeo2011 atlas in the
...
%save variables
StrSavePowerVals = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_DMN_Project/scripts/Release_20171012_scripts/scripts_task/Power_Results/Yeo_atlas/Networks_7/Encode/';
StrSaveSubjIndGlobal = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_DMN_Project/scripts/Release_20171012_scripts/scripts_task/Subject_Indices/Yeo_atlas/Individual/Encode/';
...
for i_All = 1:6
    ...
    if (~isempty(SubjInd))
        ...
        Power_UltraSlow_Delta = [Power_UltraSlow_Delta; PowerCalc_PCCPrec_X_UltraSlow(RegXData, UltraSlow_Delta)];
        Power_UltraSlow_Delta_Theta = [Power_UltraSlow_Delta_Theta; PowerCalc_PCCPrec_X_UltraSlow(RegXData, UltraSlow_Delta_Theta)];
        Power_Delta_Theta = [Power_Delta_Theta; PowerCalc_PCCPrec_X(RegXData, Delta_Theta)];       
        Power_UltraSlow = [Power_UltraSlow; PowerCalc_PCCPrec_X_UltraSlow(RegXData, UltraSlow)];
        Power_HighGamma = [Power_HighGamma; PowerCalc_PCCPrec_X_HighGamma(RegXData, HighGamma)];
        Power_Delta = [Power_Delta; PowerCalc_PCCPrec_X(RegXData, Delta)];
        Power_Theta = [Power_Theta; PowerCalc_PCCPrec_X(RegXData, Theta)];
        Power_Alpha = [Power_Alpha; PowerCalc_PCCPrec_X(RegXData, Alpha)];
        Power_Beta = [Power_Beta; PowerCalc_PCCPrec_X(RegXData, Beta)];
        Power_Gamma = [Power_Gamma; PowerCalc_PCCPrec_X_Gamma(RegXData, Gamma)];
       
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_UltraSlow_Delta_Corrected_ArtifactRemove.mat'),'Power_UltraSlow_Delta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_UltraSlow_Delta_Theta_Corrected_ArtifactRemove.mat'),'Power_UltraSlow_Delta_Theta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_Delta_Theta_Corrected_ArtifactRemove.mat'),'Power_Delta_Theta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_UltraSlow_Corrected_ArtifactRemove.mat'),'Power_UltraSlow');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_Delta_Corrected_ArtifactRemove.mat'),'Power_Delta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_Theta_Corrected_ArtifactRemove.mat'),'Power_Theta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_Alpha_Corrected_ArtifactRemove.mat'),'Power_Alpha');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_Beta_Corrected_ArtifactRemove.mat'),'Power_Beta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_Gamma_Corrected_ArtifactRemove.mat'),'Power_Gamma');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HighGamma_Corrected_ArtifactRemove.mat'),'Power_HighGamma');
