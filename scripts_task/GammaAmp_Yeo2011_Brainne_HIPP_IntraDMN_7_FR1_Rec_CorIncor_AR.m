%Anup Das
%8 April, 2019
%Gamma amplitude calculation for intra-DMN-networks in the Yeo2011 
%atlas with the hippocampus for the recall periods of the FR1 task
...
%Gamma amplitude values
GammaAmplitudeVals_intra = [];
...
%save variables
StrSaveGammaVals = '/oak/stanford/groups/menon/projects/a1das/2018_ECoG_DMN_Project/scripts/Release_20171012_scripts/scripts_task/Gamma_Results/Yeo_atlas/Recall/Intra_7/';
...
for i_intraDMN = 20:27
    ...
    if (~isempty(SubjInd))
        ...
        [GammaVals, GammaValsVec] = GammaBandFluctuationCalc_Amplitude(RegXData, RegYData);
        GammaAmplitudeVals_intra = [GammaAmplitudeVals_intra; GammaVals];
...
save(strcat(StrSaveGammaVals,'CorrIncorr_GammaAmplitudeVals_intraDMN_Yeo2011_Brainnetome_HIPP_Corrected_ArtifactRemove.mat'),'GammaAmplitudeVals_intra');
