...
%for recall periods (correct) in the FR1 task
    ...
    for j_intraDMN = i_intraDMN+1:27
        ...
        if (~isempty(SubjInd))
            ...
            for i=1:size(SubjInd,1)
                ...
                Recalled_Correct = CountStart_Word_Recall(Recalled_Mat_Word==0);
...
save(strcat(StrSavePLVVals,'Incorrect_PLVVals_intraDMN_Yeo2011_UltraSlow_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_UltraSlow_Delta');
save(strcat(StrSavePLVVals,'Incorrect_PLVVals_intraDMN_Yeo2011_UltraSlow_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_UltraSlow_Delta_Theta');
save(strcat(StrSavePLVVals,'Incorrect_PLVVals_intraDMN_Yeo2011_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Delta_Theta');
save(strcat(StrSavePLVVals,'Incorrect_PLVVals_intraDMN_Yeo2011_UltraSlow_Corrected_ArtifactRemove.mat'),'PLVVals_intra_UltraSlow');
save(strcat(StrSavePLVVals,'Incorrect_PLVVals_intraDMN_Yeo2011_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Delta');
save(strcat(StrSavePLVVals,'Incorrect_PLVVals_intraDMN_Yeo2011_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Theta');
save(strcat(StrSavePLVVals,'Incorrect_PLVVals_intraDMN_Yeo2011_Alpha_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Alpha');
save(strcat(StrSavePLVVals,'Incorrect_PLVVals_intraDMN_Yeo2011_Beta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Beta');
save(strcat(StrSavePLVVals,'Incorrect_PLVVals_intraDMN_Yeo2011_Gamma_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Gamma');
save(strcat(StrSavePLVVals,'Incorrect_PLVVals_intraDMN_Yeo2011_HighGamma_Corrected_ArtifactRemove.mat'),'PLVVals_intra_HighGamma');
