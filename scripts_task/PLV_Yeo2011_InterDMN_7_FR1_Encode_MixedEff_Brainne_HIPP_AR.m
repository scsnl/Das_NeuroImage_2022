%Anup Das
%30 August, 2019
%Creating mixed effects models for inter-DMN (including the hippocampus) in the Yeo2011 atlas for 7-Networks in the
...
Subject_Files = dir(strcat(Subject_Files_Dir, 'SubjIndGlobal_interDMN_*_HIPP_*.mat'));
Subject_All = {};
...
for i_interDMN = 1:6
    ...
    if (~isempty(SubjInd))
        ...
        save(strcat(StrSavePLVVals,'Subj_Pairs_interDMN_',num2str(i_interDMN),'_Yeo2011_Brainnetome_HIPP_ArtifactRemove.mat'),'Subj_Pairs');
