...
save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_intraDMN_Yeo2011_Brainnetome_HIPP_UltraSlow_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_UltraSlow_Delta');
save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_intraDMN_Yeo2011_Brainnetome_HIPP_UltraSlow_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_UltraSlow_Delta_Theta');
save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_intraDMN_Yeo2011_Brainnetome_HIPP_Delta_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Delta_Theta');
save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_intraDMN_Yeo2011_Brainnetome_HIPP_UltraSlow_Corrected_ArtifactRemove.mat'),'PLVVals_intra_UltraSlow');
save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_intraDMN_Yeo2011_Brainnetome_HIPP_Delta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Delta');
save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_intraDMN_Yeo2011_Brainnetome_HIPP_Theta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Theta');
save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_intraDMN_Yeo2011_Brainnetome_HIPP_Alpha_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Alpha');
save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_intraDMN_Yeo2011_Brainnetome_HIPP_Beta_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Beta');
save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_intraDMN_Yeo2011_Brainnetome_HIPP_Gamma_Corrected_ArtifactRemove.mat'),'PLVVals_intra_Gamma');
save(strcat(StrSavePLVVals,'NA_CorrIncorr_PLVVals_intraDMN_Yeo2011_Brainnetome_HIPP_HighGamma_Corrected_ArtifactRemove.mat'),'PLVVals_intra_HighGamma');
