%Anup Das
%30 August, 2019
%Power calculation for the DMN in the Yeo2011 atlas in the
...
%         end
    ...
    if (~isempty(SubjInd))
        ...
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HIPP_UltraSlow_Delta_Corrected_ArtifactRemove_1229.mat'),'Power_UltraSlow_Delta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HIPP_UltraSlow_Delta_Theta_Corrected_ArtifactRemove_1229.mat'),'Power_UltraSlow_Delta_Theta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Delta_Theta_Corrected_ArtifactRemove_1229.mat'),'Power_Delta_Theta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HIPP_UltraSlow_Corrected_ArtifactRemove_1229.mat'),'Power_UltraSlow');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Delta_Corrected_ArtifactRemove_1229.mat'),'Power_Delta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Theta_Corrected_ArtifactRemove_1229.mat'),'Power_Theta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Alpha_Corrected_ArtifactRemove_1229.mat'),'Power_Alpha');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Beta_Corrected_ArtifactRemove_1229.mat'),'Power_Beta');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HIPP_Gamma_Corrected_ArtifactRemove_1229.mat'),'Power_Gamma');
        save(strcat(StrSavePowerVals,'CorrIncorr_PowerVals_',num2str(i_All),'_Yeo2011_HIPP_HighGamma_Corrected_ArtifactRemove_1229.mat'),'Power_HighGamma');
